...
model = dict(
    type='ScanNet200MixFormer3D_Online_Tiny',
...
# learning rate
param_scheduler = dict(type='PolyLR', begin=0, end=1000, power=0.9)
...
train_cfg = dict(type='EpochBasedTrainLoop', max_epochs=1000, val_interval=15)
